...
import bathroom9 from "../../images/slider/bathroom/9.webp";
import bathroom10 from "../../images/slider/bathroom/10.webp";

const arr: ISliderItem[] = [
  { id: 1, src: bathroom1, title: "Beautiful Tiling Work" },
  { id: 2, src: bathroom2, title: "Expert Tiling Services" },
  { id: 3, src: bathroom3, title: "Quality Tiles for Your Home" },
  { id: 4, src: bathroom4, title: "Professional Tiling Solutions" },
  { id: 5, src: bathroom5, title: "Affordable Tile Installation" },
  { id: 6, src: bathroom6, title: "Stunning Tiling Designs" },
